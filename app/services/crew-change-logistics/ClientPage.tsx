...
const services = [
  ...
  { title: 'Visa & Immigration Handling', description: 'Support with documentation, transit visas, and clearances.' },
...
const testimonials = [
  {
    quote: 'Breakwater handled our entire crew change seamlessly. Immigration, transit, and accommodation were all spot on.',
    name: 'Operations Manager, Offshore Wind Project',
  },
  {
    quote: 'Incredible responsiveness. We had last-minute changes and the Breakwater team had solutions ready instantly.',
    name: 'Logistics Lead, Deepwater Drilling Co.',
  },
  {
    quote: 'Our crew was impressed with how smooth everything went. Zero stress and total professionalism.',
    name: 'Captain, Bulk Carrier Vessel',
  },
]

export default function CrewChangeClientPage() {
      ...
      <section className="py-20 px-4 md:px-8 text-center">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
            Our dedicated operations team is available 24/7 to handle even the most time-sensitive logistics.
          </p>
          <Button>
